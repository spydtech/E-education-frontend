    ...
    <>
      <div className="flex mb-10 flex-1 w-full flex-col items-center justify-center text-center px-4 py-10 bg-[#0098f1] text-white">
        ...
        <h2 className="mt-5 md:mt-10 max-w-xl text-lg lg:text-xl leading-7">
          Learn how to develop autonomous agents that think, reason, and take
          action. Gain hands-on experience with cutting-edge tools and
          strategies used to build intelligent, agentic systems that power the
          future.
        </h2>
        <a
          className="bg-white text-[#1b1f3a] hover:text-[#00d2ff] font-medium rounded-xl px-10 py-3 mt-5 transition"
          href=""
