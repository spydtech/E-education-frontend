...
const AgenticAIAbout = () => {
  const PhpAbout = [
    {
      title: "Student Support",
      description:
        "Learn about the latest Agentic AI techniques and tools to build robust and scalable applications.",
      imgSrc: programmer,
    ...
    },
    {
      ...
      description:
        "Gain expertise in Agentic AI and receive support to advance your career in this growing field.",
      imgSrc: assistance,
    ...
    <div className="px-3 text-center">
      <div>
        <p className="md:text-2xl font-bold text-[#0098F1]">
          Discover the Agentic AI Programs
        </p>
      </div>
