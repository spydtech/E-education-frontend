...
function GenerativeAIFoot() {
  const [courseName] = useState("Master Generative AI");
    ...
    <>
      <div className="flex mb-10 flex-1 w-full flex-col items-center justify-center text-center px-4 py-10 bg-[#0098f1] text-white">
        ...
        <h2 className="mt-5 md:mt-10 max-w-xl text-lg lg:text-xl leading-7">
          Dive into the world of Generative AI with hands-on projects, LLMs,
          prompt engineering, and real-world applications. Upskill for the
          AI-driven future!
        </h2>
        <a
...
export default GenerativeAIFoot;
