  ...
  const courseData = [
    {
      ...
      description:
        "Browse our extensive catalog of GenerativeAI courses Discover beginner-friendly to advanced-level programs designed to accommodate learners of all backgrounds.",
    },
    {
      imgSrc:
      ...
      description:
        "Start with foundational courses covering basic concepts algorithms, and programming languages essential for GenerativeAI.",
    },
    {
      imgSrc:
    ...
    },
    {
      ...
      description:
        "Monitor your progress with intuitive dashboards and tracking tools. Set goals, track milestones, and measure your proficiency in various GenerativeAI concepts as you advance through the courses.",
    },
    {
      imgSrc:
      ...
      description:
        "Choose specialized tracks or advanced courses to delve deeper into specific areas of GenerativeAI, such as deep learning, natural language processing, or computer vision. Customize your learning path to align with your interests and career goals.",
    },
    {
      imgSrc:
