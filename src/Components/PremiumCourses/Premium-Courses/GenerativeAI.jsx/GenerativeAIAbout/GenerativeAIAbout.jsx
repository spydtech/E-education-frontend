...
const GenerativeAIAbout = () => {
  const PhpAbout = [
    {
      title: "Student Support",
      description:
        "Learn about the latest GenerativeAI techniques and tools to build robust and scalable applications.",
      imgSrc: programmer,
    ...
    },
    {
      ...
      description:
        "Gain expertise in GenerativeAI and receive support to advance your career in this growing field.",
      imgSrc: assistance,
    ...
    <div className="px-3 text-center">
      <div>
        <p className="md:text-2xl font-bold text-[#0098F1]">
          Discover the GenerativeAI Programs
        </p>
      </div>
...
export default GenerativeAIAbout;
