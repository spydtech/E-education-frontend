  ...
  return (
    ...
    <div className="flex justify-center items-center">
      <div className="w-full max-w-lg bg-white p-8 text-center border-2 border-gray-300 shadow-lg">
        ...
        <h3 className="text-2xl font-bold mb-12 text-blue-600">ETHICAL HACKING</h3>
    ...
    <div className="space-y-3 text-center md:text-left font-poppins">
      ...
      <p className="md:text-xl text-gray-500">
        Successfully complete all course modules to obtain a Certified EthicalHacking certification, greatly enhancing career prospects and skill development.
      </p>
    </div>
  </div>
  );
