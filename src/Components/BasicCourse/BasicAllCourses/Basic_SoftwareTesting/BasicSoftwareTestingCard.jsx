...
const BasicSoftwareTestingCard = () => {
  const courseData = [
    {
      imgSrc: Img1,
      title: "Explore Course Catalog",
      description:
        "Browse our extensive catalog of Software Testing course. Discover beginner-friendly to advanced-level programs designed to accommodate learners of all backgrounds.",
    },
    {
      imgSrc: Img2,
      title: "Enroll in Foundational Courses",
      description:
        "Start with foundational courses covering basic concepts, tools, and methodologies essential for Software Testing.",
    },
    {
      imgSrc: Img3,
      title: "Practice with Real-world Projects",
      description:
        "Apply your knowledge by working on hands-on projects tailored to real-world scenarios. Gain practical experience in Software Testing, and web application design under the guidance of industry experts.",
    },
    {
      imgSrc: Img4,
    ...
    },
    {
      ...
      description:
        "Choose specialized tracks or advanced courses to delve deeper into specific areas of Software Testing, such as frameworks, API integration, Customize your learning path to align with your interests and career goals.",
    },
    {
      imgSrc: Img6,
  ...
  return (
    <section
      id="portfolio"
      className="portfolio-section py-10 px-4 font-poppins"
    >
...
export default BasicSoftwareTestingCard;
