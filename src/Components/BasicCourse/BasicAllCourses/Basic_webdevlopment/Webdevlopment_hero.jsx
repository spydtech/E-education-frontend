...
const WebDevlopmentHero = () => {
  const [courseName] = useState("Web Development Fundamentals"); // Updated course name
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <p className="text-center text-white max-md:text-[16px] text-[20px] font-medium px-4">
            Master the foundations of web development. Learn HTML, CSS, and JavaScript to build<br/> 
