...
function BasicWebdevlopmentCertificate() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 justify-center items-center md:px-10 md:gap-8 font-poppins">
      ...
      <div className="flex justify-center items-center">
        <div className="w-full max-w-lg bg-white p-8 text-center border-2 border-gray-300 shadow-lg">
          ...
          <h3 className="text-2xl font-bold mb-12 text-blue-600">WEB DEVELOPMENT</h3>
      ...
      <div className="space-y-3 text-center md:text-left">
        ...
        <p className="md:text-xl text-gray-500">
          Successfully complete all course modules to obtain a Web Development certification, greatly enhancing career prospects and skill development.
        </p>
      </div>
    </div>
  );
...
export default BasicWebdevlopmentCertificate;