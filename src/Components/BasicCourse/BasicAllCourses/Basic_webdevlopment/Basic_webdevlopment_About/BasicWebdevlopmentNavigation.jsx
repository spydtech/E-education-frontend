...
import BasicWebdevlopmentIntroduction from "./BasicWebdevlopmentIntroduction";
import BasicWebdevlopmentKeyHighlights from "./BasicWebdevlopmentKeyHighlights";
import BasicWebdevlopmentCareers from "./BasicWebdevlopmentCarrier";
import BasicWebdevlopmentAbout from "./BasicWebdevlopment_About";
import BasicWebdevlopmentCertificate from "./BasicWebdevlopmentCertificate";
import BasicWebdevlopmentSyallabus from "./BasicWebdevlopmentSyallabus";

const BasicWebdevlopmentNavigation = () => {
  const sections = [
    "Introduction",
    "Key Highlights",
    "Career Outcomes",
  ...
  return (
    <>
      ...
      <div className="mx-5 font-poppins">
        {currentSection === 0 && <BasicWebdevlopmentIntroduction />}
        {currentSection === 1 && <BasicWebdevlopmentKeyHighlights />}
        {currentSection === 2 && <BasicWebdevlopmentCareers />}
        {currentSection === 3 && <BasicWebdevlopmentAbout />}
        {currentSection === 4 && <BasicWebdevlopmentCertificate />}
        {currentSection === 5 && <BasicWebdevlopmentSyallabus />}
      </div>
    </>
  );
};

export default BasicWebdevlopmentNavigation;
