...
function GroupTable({ groupName, users, onRemoveUser, onAddUser, trainees, groupId }) {
  ...
  const handleAddUser = async (user) => {
    try {
      const response = await axios.post(
        `${API_BASE_URL}/api/groups/${groupId}/add-users`,
        [user.email],
        {
          headers: {
            Authorization: `Bearer ${jwt}`,
  ...
  const setTrainee = async (trainee) => {
    ...
    try {
      const response = await axios.post(
        `${API_BASE_URL}/api/groups/${groupId}/add-trainees`,
        [trainee.email],
        {
          headers: {
            Authorization: `Bearer ${jwt}`,
  ...
  {selectedTrainee || (trainees && trainees.fullName ? trainees.fullName : "No Trainee Assigned")}
</span>
