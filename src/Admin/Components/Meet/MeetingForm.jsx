...
// Remove this line if you don't actually use MeetingCalendar
...
const MeetingForm = () => {
  ...
  const [showMeetings, setShowMeetings] = useState(true); // Show meetings by default
    ...
    <div className="font-poppins">
      ...
      <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4 sm:mb-0">Meetings</h1>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              title="View Calendar"
            >
              <svg width="32" height="32" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M15.9795 7V12.3875M33.9377 7V12.3875" stroke="#494949" strokeWidth="4.08333" strokeLinecap="round"/>
              </svg>
            </button>
            ...
            <div className="relative bg-white rounded-xl shadow-xl w-full max-w-md">
              ...
              <div className="p-6">
                <form onSubmit={handleSubmit}>
                  ...
                  {/* Select Group */}
                  <div className="mb-4">
                    <label htmlFor="groupSelect" className="block mb-2 text-sm font-medium text-gray-700">
                      Select a group *
                    </label>
                    <select
                      id="groupSelect"
                      ...
                      className="block w-full p-3 border text-black bg-white border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-[#FF9B26] focus:border-[#FF9B26] transition-colors"
                      required
                    >
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      className="mt-1 p-3 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-[#FF9B26] focus:border-[#FF9B26] transition-colors"
                      required
                  ...
                  <div className="mt-6">
                    <button 
                      type="submit" 
                      className="w-full bg-[#FF9B26] text-white py-3 px-4 rounded-lg font-medium hover:bg-orange-600 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
                    >
                      Schedule Meeting
                    </button>
                  </div>
        ...
        <div className="mt-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="text-sm text-gray-600">
              Total: {meetingList.length} meetings
            </div>
          </div>

          {loading ? (
            <div className="text-center py-12">
              <div className="inline-block animate-spin rounded-full h-12 w-12 border-b-2 border-[#FF9B26]"></div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
              ...
              <button 
                onClick={openForm}
                className="mt-4 inline-flex items-center px-4 py-2 bg-[#FF9B26] text-white rounded-lg hover:bg-orange-600 transition-colors duration-300"
              >
                  ...
                  <div className="p-5">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center text-sm text-gray-600">
                        ...
                        <span>{meeting.fromDate} - {meeting.toDate}</span>
                      </div>
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-100">
                      <a
                        ...
                        className="flex items-center justify-center w-full py-2.5 px-4 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-colors duration-300 font-medium"
                      >
                        <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
